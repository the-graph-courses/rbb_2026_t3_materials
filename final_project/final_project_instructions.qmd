...
::: {.callout-important}
## Special instructions for UNODA/BWC-sponsored students

If your place in this course is sponsored by the UNODA BWC programme, your final project must include at least one biosecurity-relevant DHS variable from [this list](https://github.com/the-graph-courses/misc_public/blob/main/unoda/dhs_biosecurity_relevant_variables.md){target="_blank"}.

If you are not sure whether this applies to you: this usually means students who are on a 100% scholarship and did not pay a course fee.
:::
...
**Exception for UNODA/BWC-sponsored students:** your project must include at least one of the health and disease-related DHS variables listed [here](https://github.com/the-graph-courses/misc_public/blob/main/unoda/dhs_biosecurity_relevant_variables.md){target="_blank"}. Ideally, this should be the main variable of interest that you compare across socio-demographic groups.
